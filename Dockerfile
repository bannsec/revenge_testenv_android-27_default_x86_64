...
RUN apt update && apt dist-upgrade -y && \
    ...
    echo y | /opt/tools/bin/sdkmanager "build-tools;28.0.3" >/dev/null && \
    echo y | /opt/tools/bin/sdkmanager "platforms;android-27" >/dev/null && \
    ...
    echo y | /opt/tools/bin/sdkmanager "system-images;android-27;default;x86_64" >/dev/null && \
